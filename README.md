...
This project is based only on public information, including:

- the MyCareersFuture job description
...
**Input → Identify → Diagnose → Fix → Review → Confirm**
...
Review the asset against the right criteria.
...
- tone fits the brand
- message is clear
- client objective is respected
- output is usable by the team

### 6. Confirm

Only after review should the asset move forward.
...
No pre-made website or portfolio template was used for the application project.
